Rails.application.routes.draw do
  ...
  # get "/spa-demo/pages/:name.:format", :to => redirect("/client/spa-demo/pages/%{name}.%{format}")
  # get "/spa-demo/foos/:name.:format", :to => redirect("/client/spa-demo/foos/%{name}.%{format}")
